          ...
          <Grid container style={{ pageBreakAfter: 'always', height: "100vh", display: 'flex', flexDirection: 'column', justifyContent: 'space-between'}}>
            ...
            <div style={{flex: 1}}>
              ...
              <Grid sx={{ paddingRight: '60px', paddingLeft: '60px' }}>
                ...
                >
                  {t(
                    'All information that I provide in the systematic follow-up will be treated confidentially. This consent form will be kept in a locked cabinet of the Children and Family Outpatient Service to which unauthorized persons do not have access.'
                  )}
                </Typography>
                <br />
                <Typography
